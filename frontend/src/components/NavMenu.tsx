...
export default function NavMenu({ name } : NavMenuProps) {
  ...
  return (
    <Popover className="relative">
      ...
      >
        <PopoverPanel className="absolute left-1/2 z-10 mt-5 flex w-screen sm:max-w-min -translate-x-1/2 sm:-translate-x-48">
          <div className="w-full sm:w-56 shrink rounded-xl bg-white p-4 text-sm font-semibold leading-6 text-gray-900 shadow-lg ring-1 ring-gray-900/5">
            <p className='text-center'>Hola: {firstName}</p>
            <Link
              to='/profile'
